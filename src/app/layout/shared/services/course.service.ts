...
export class CourseService {
  ...
  public deleteSubscription(id: number, iduser: number): Observable<any> {
    return this.http.get(this.BaseUrl + "/inscription/delete/subscription?idtrain=" + id +"&iduser="+iduser);
  }
